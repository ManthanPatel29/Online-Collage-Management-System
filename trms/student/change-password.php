...
if (isset($_SESSION['trmssid'])) {
    if(isset($_POST['submit']))
    {
        ...
        $sql ="SELECT Name FROM tblstudents WHERE Enrollment=:studentid and Password=:cpassword";
        ...
        if($query -> rowCount() > 0)
        {
            $con="update tblstudents set Password=:newpassword where Enrollment=:studentid";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <i class="fa fa-dot-circle-o"></i> Change Password</button></p>
                            </form>
                        </div>
                    </div>
                </div>

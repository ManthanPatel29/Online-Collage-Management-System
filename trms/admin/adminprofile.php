        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Admin Profile</strong></div>
                            <form name="profile" method="post" action="">
                                ...
                                ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="" value="<?php  echo $row->AdminRegdate;?>" readonly="" class="form-control">
                                            </div>
                                        </div>
                                    </div>                     
                                </div>
                                 ...
                                 <div class="card-footer">
                                   <p style="text-align: center;"><button type="submit" class="btn btn-primary btn-sm" name="submit" id="submit"><i class="fa fa-dot-circle-o"></i> Update Details </button></p> 
                                </div>
                            </form>
                        </div>
                    </div>

...
if (isset($_SESSION['trmstid'])) 
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        elseif($_FILES['myfile']['size'] > 1000000) { // file shouldn't be larger than 1Megabyte
            ...
            $stmt = $dbh->prepare("insert into tblattendance values('',?,?,?,?)");
...
<head>
    ...
    <title>Add Attendance Sheet</title>
    <meta charset="utf-8"/>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add Attendancesheet</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Add Attendancesheet</strong></div>
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        <label for="company" class="form-control-label"><b>Add AttendanceSheet</b></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                            $sql="SELECT subID,SubjectName from  tblsubjects where TeacherID = '$teacherid' ";
                                ...
                                <p style="text-align: center;">
                                     <button type="submit" class="btn btn-primary btn-sm" name="submit" id="submit"><i class="fa fa-dot-circle-o"></i> Upload Attandance Sheet</button> 
                                </p>
                            </form>
                        </div>
                    </div>

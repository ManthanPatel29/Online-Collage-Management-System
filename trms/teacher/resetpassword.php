...
if(isset($_POST['submit']))
  {
    ...
    $query = $dbh->prepare("update tblteacher set Password='$password'  where  Email = '$email' AND MobileNumber = '$contactno' ");
...
<body class="bg-dark" style=" background-image: url('images/bg.jpg');">
    ...
    echo $msg;
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Your Mobile Number" name="contactno" pattern="[0-9]{10}" title="10 digit's mobile number only" required="true">
                        </div>
                        <div class="form-group">
                                <label>New Password</label>
                                <input type="text" class="form-control" placeholder="New Password" name="newpassword" required="true">
                        </div>
                            <div class="form-group">

                            ...
                            <div class="card-header"><strong>Time Table</strong></div>
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        <?php
                                            $sql=$dbh -> prepare("select ID,filename,Semester from  tbltimetable");
                                            $sql->execute();
                                        ...
                                        <table class="table">
                                            ...
                                            <tr style="text-align:center;">
                                              ...
                                              <td> <a target="_blank" href="viewtimetable.php?fid=<?php echo $row['ID']; ?>"><button type="submit" class="btn btn-primary btn-sm" name="submit" id="submit">Download</button></a></td>
                                            </tr>
                                            <?php
                                                        $cnt=$cnt+1;
                                                }
